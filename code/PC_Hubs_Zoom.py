...
def plot_overall(ax1,flag):
    ...
    ax1.text(0.8,5,'P = 0.48',fontsize=90,color='red')
    return data, label
...
def plot_visual(ax1,flag):
    ...
    ax1.text(0.8, 5, 'P = 0.78', fontsize=90, color='red')
    return data, label
...
def plot_audio(ax1,flag):
    ...
    ax1.text(0.8, 5, 'P = 0.11', fontsize=90, color='red')
    return data, label
...
def plot_presence(ax1,flag):
    ...
    ax1.text(0.8, 5, 'P = 0.044', fontsize=90, color='red')
    return data, label
...
def plot_copresence(ax1,flag):
    ...
    ax1.text(0.8, 5, 'P = 0.018', fontsize=90, color='red')
    return data, label
...
def plot_social_interaction(ax1,flag):
    ...
    ax1.text(0.8, 5, 'P = 0.41', fontsize=90, color='red')
    return data, label
...
if __name__ == '__main__':
    ...
    if args.bar:
        ...
        # ax1.set_aspect(1.5)
        ax1.text(0.05, 1.5, 'PC Users', fontsize=90, color='red')
